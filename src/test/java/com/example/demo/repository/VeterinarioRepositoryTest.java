...
public class VeterinarioRepositoryTest {
    ...
    @BeforeEach
    void init() {
        veterinarioRepository.save(new Veterinario(123488000, "Javier", "Perez", "javi@example.com", "12345678",
                "foto.jpg", "cirujano", true));
        veterinarioRepository.save(new Veterinario(123499000, "Ana", "González", "ana@example.com", "12345678",
                "foto.jpg", "oftalmólogo", true));
        veterinarioRepository.save(new Veterinario(123410000, "María", "López", "maria@example.com", "12345678",
                "foto.jpg", "dermatólogo", true));
        veterinarioRepository.save(new Veterinario(123411000, "Pedro", "Rodríguez", "pedro@example.com", "12345678",
                "foto.jpg", "endocrinólogo", true));
        veterinarioRepository.save(new Veterinario(123412000, "Sofía", "Martínez", "sofia@example.com", "12345678",
                "foto.jpg", "neurólogo", true));
    }
    ...
    public void VeterinarioRepository_save_Veterinaro() {
        ...
        // arrange
        Veterinario veterinario = new Veterinario(123456000, "Juan", "Perez", "juan@example.com", "12345678",
                "foto.jpg", "cirujano", true);
    ...
    public void VeterinarioRepository_findAll_NotEmptyList() {
        ...
        // arrange
        Veterinario veterinario = new Veterinario(123456000, "Juan", "Perez", "juan@gmail.com", "12345678", "foto.jpg",
                "cirujano", true);
        Veterinario veterinario2 = new Veterinario(123456080, "Memo", "Dias", "memo@gmail.com", "12345678", "foto2.jpg",
                "cirujano", true);
